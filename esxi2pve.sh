...
###
# This script hepls import VM from ESXI 6.5
###
...
STORAGE=""
echo "Storage list:"
ls -l /rpool/esxi | grep '^d' | awk '{print $9}'
echo
echo "Please input input storage name for procesing"
read -e -p "> " -i "${STORAGE}" STORAGE
exit 0

ls /rpool/esxi/slon4-Win7-HDD1-2TB/*/*.vmx